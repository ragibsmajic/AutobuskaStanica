...
{
	if(telPozivni != kodDrzavePozivni) 
	{
...
function validirajFormuZaNovostDesno()
{
	...
	else if(document.getElementById("telBrojDesno").value.length < 7)
	{
		document.getElementById("porukaDesno").innerHTML = "Telefonski ne može biti kraći od 10 cifara!";
		return false;
	}
...
function validirajFormuZaNovostLijevo()
{
	...
	else if(document.getElementById("telBrojLijevo").value.length < 7)
	{
		document.getElementById("porukaLijevo").innerHTML = "Telefonski ne može biti kraći od 10 cifara!";
		return false;
	}
