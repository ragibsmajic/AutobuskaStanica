	...
	<body onload="azurirajVrijemeObjave(); provjeriNevideneKomentare();">
		...
		<section id="lijevaSekcija">
				...
				echo "<div class='postLijevaSekcijaFormaZaPostavljanje'>";
					...
					echo "<div id='formaZaPostavljanjeObavijesti'>";
						...
						echo "<form id='formaNovost' action='index.php' onsubmit='return validirajFormuZaNovostLijevo();' method='POST' enctype='multipart/form-data'>";
								...
								echo "<br><br>";
								echo "<input type='checkbox' id='checkboxLijevo' name='otvorenoZaKomentare' value='1'>";
								echo "<label id='checkboxLabel' for='otvorenoZaKomentare'>Novost je otvorena za komentare</label>";
								echo "<br><br>";
			...
			if(isset($_GET['autor']) && is_numeric($_GET['autor']))
				$novosti = dajNovostiLijeveSekcijeAutoraPoID($_GET['autor'], $sortiranje);
			else
		...
		<section id="desnaSekcija">
			<?php
					...
					echo "<div class='postDesnaSekcijaFormaZaPostavljanje'>";
						...
						echo "<div id='formaZaPostavljanjeObavijesti'>";
							echo "<form id='formaNovost' action='index.php' onsubmit='return validirajFormuZaNovostDesno();' method='POST' enctype='multipart/form-data'>";
								...
								echo "<br><br>";
								echo "<input type='checkbox' id='checkboxDesno' name='otvorenoZaKomentare' value='1'>";
								echo "<label id='checkboxLabel' for='otvorenoZaKomentare'>Novost je otvorena za komentare</label>";
								echo "<br><br>";
				...
				$novosti = array();
				if(isset($_GET['autor']) && is_numeric($_GET['autor']))
					$novosti = dajNovostiDesneSekcijeAutoraPoID($_GET['autor'], $sortiranje);
				else
